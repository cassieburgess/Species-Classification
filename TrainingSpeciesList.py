...
def GeneralTrainingList(Locations, Species, Name, imageName, Start, End):
    ...
    Ims = createImList(Name, 48) #create the image name list 
...
def createAllTransectTraining(): 
    ...
    FullTrainSpecies = np.concatenate((USSMay25TrainSpecies, USSJune3TrainSpecies, USSJune7TrainSpecies, NNGJune2TrainSpecies, BSSMay19TrainSpecies, BSSMay26TrainSpecies, BSSJune3TrainSpecies, BSSJune8TrainSpecies, BRSMay27TrainSpecies), axis = 0)
